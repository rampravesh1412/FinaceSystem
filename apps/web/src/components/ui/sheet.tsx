 ...
 * Slide-over panel.
 *
 * Two jobs in this app: the mobile navigation drawer (§48), and the transaction details
 * drawer (§46), which is why the `right` variant is wide enough for a ledger table.
 */
...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-card shadow-raised transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-200 data-[state=open]:duration-300",
  {
    variants: {
      side: {
